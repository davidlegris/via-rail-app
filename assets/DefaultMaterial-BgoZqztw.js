const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-CGVBiDdW.js","assets/index-BflxWSe4.js","assets/index-Dv_X_BGc.css","assets/Geometry-zarE0jnW.js","assets/renderState-Cv_9OmW9.js","assets/basicInterfaces-CZwQPxTp.js","assets/ShaderOutput-DnYY5J1_.js","assets/mat4f64-Dk4dwAN8.js","assets/BindType-BBwFZqyN.js","assets/glsl-BH37Aalp.js","assets/mat3f64-q3fE-ZOt.js","assets/VertexAttribute-Cq4MnHjR.js","assets/boundedPlane-DxQGnLLV.js","assets/sphere-BdzKErpY.js","assets/plane-0BNnDuSS.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-CDpS1D3a.js","assets/orientedBoundingBox-DqlvL7e_.js","assets/quat-BrjpcWik.js","assets/spatialReferenceEllipsoidUtils-30NT1zsw.js","assets/computeTranslationToOriginAndRotation-PjaOBAHP.js","assets/requestImageUtils-D2XkoFer.js","assets/TextureFormat-1mYWTFa-.js","assets/InterleavedLayout-gWBEEY_U.js","assets/BufferView-CSoaoejH.js","assets/types-D0PSWh4d.js","assets/Indices-CYlzeTde.js","assets/triangle-CCUkgOi_.js","assets/glUtil-CKjV1kX9.js","assets/VertexElementDescriptor-BLyltQyJ.js","assets/HUDMaterial-DynX8UyT.js","assets/Octree-RKPteMCw.js","assets/VertexArrayObject-C-1lD9G5.js","assets/floatRGBA-PfplR2xz.js","assets/dehydratedFeatureUtils-BtI6NQdt.js","assets/doublePrecisionUtils-B0owpBza.js","assets/meshVertexSpaceUtils-CXkA3Ol2.js","assets/MeshLocalVertexSpace-p56f842n.js","assets/projectVectorToVector-C7jcbsP7.js","assets/projectPointToVector-Cal3_EKh.js","assets/hydratedFeatures-Cm9O3Av_.js","assets/vec3f32-nZdmKIgz.js","assets/ShaderBuilder-X_pRHb_Y.js","assets/IntersectorInterfaces-CmNINbyF.js","assets/NormalAttribute.glsl-CZiUoAi5.js"])))=>i.map(i=>d[i]);
import{iz as $e,kc as ta,k7 as Q,bI as oa,k6 as Ee,ic as Aa,fd as U,bL as E,lN as _a,_ as me,gN as ra,jZ as ne,D as s,F as xe,J as Ga,bj as oe,ds as La,dw as je,dz as Ra,dx as Fa,d8 as Pa,hc as Da,jD as ja,jR as Va,aZ as Ba,bT as O,e9 as Ha,aB as Wa,oI as Ua,k3 as Ve,kh as Be,c7 as qa,bN as Ya,bZ as ka,eV as be,f9 as Za,eY as He,bV as Xa,ia as Ja}from"./index-BflxWSe4.js";import{H as Ka}from"./InterleavedLayout-gWBEEY_U.js";import{n as g,u as ee,t as We,o as Te,r as Qa}from"./ShaderOutput-DnYY5J1_.js";import{n as I,a as T,t as he}from"./NormalAttribute.glsl-CZiUoAi5.js";import{a7 as et,a8 as at,a9 as G,aa as tt,ab as ot,ac as rt,ad as se,p as it,ae as nt,af as st,e as _,B as F,a as j,ag as V,ah as B,u as K,C as N,ai as H,D as lt,v as ct,aj as dt,J as P,ak as ut,al as ia,y as na,am as sa,an as la,ao as mt,F as Oe,G as fe,ap as ca,aq as ht,g as le,ar as ft,as as pt,at as we,au as re,k as da,o as $,av as h,aw as ze,ax as Ne,ay as ce,j as vt,az as gt,aA as xt,q as ua,aB as bt,x as Tt,aC as ma,aD as ha,c as de,aE as fa,aF as pa,z as va,r as ga,aG as xa,aH as ue,aI as ba,X as wt,E as Ue,H as Mt,aJ as yt,aK as St,aL as Ct,aM as Nt,aN as $t,aO as Et,aP as Ot,I as zt,K as R,L as d,M as It,O as Me,aQ as At,U as _t,aR as Gt,d as Lt,aS as Rt,Y as Ft,a4 as Pt}from"./Geometry-zarE0jnW.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{i as A,a as qe,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{e as Ie,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import{o as Dt,r as jt}from"./doublePrecisionUtils-B0owpBza.js";import{a as Ae}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-X_pRHb_Y.js";import{B as _e,g as Ge,f as Vt}from"./renderState-Cv_9OmW9.js";function Bt(a){a.vertex.code.add(r`
...
}`))}const ea=E(),z=ta();function lo(a){const e=a.fragment.code;e.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
return outColor;
}`);break;default:$e(e.pbrMode);case h.COUNT:}}let co=class extends ua{constructor(e,t,o){super(e,"mat4",Ae.Draw,(i,n,c,m)=>i.setUniformMatrix4fv(e,t(n,c,m)),o)}};class uo extends ua{constructor(e,t,o){super(e,"mat4",Ae.Pass,(i,n,c)=>i.setUniformMatrix4fv(e,t(n,c)),o)}}function $a(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new uo("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),Oa(a))}function Ea(a,e){e.receiveShadows&&(a.fragment.uniforms.add(new co("shadowMapMatrix",(t,o)=>o.shadowMap.getShadowMapMatrices(t.origin),4)),Oa(a))}function Oa(a){const e=a.fragment;e.include(Sa),e.uniforms.add(new da("shadowMap",t=>t.shadowMap.depthTexture),new bt("numCascades",t=>t.shadowMap.numCascades),new $("cascadeDistances",t=>t.shadowMap.cascadeDistances)).code.add(r`int chooseCascade(float depth, out mat4 mat) {
